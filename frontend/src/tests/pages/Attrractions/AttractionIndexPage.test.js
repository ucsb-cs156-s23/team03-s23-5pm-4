...
describe("AttractionIndexPage tests", () => {
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/attractions/all").reply(200, attractionFixtures.threeAttractions);
        axiosMock.onDelete("/api/attractions").reply(200, "Attraction with id 2 was deleted");
       ...
       expect(getByTestId(`${testId}-cell-row-0-col-id`)).toHaveTextContent("2"); 
        ...
        await waitFor(() => { expect(mockToast).toBeCalledWith("Attraction with id 2 was deleted") });
